...
import { businessNameSearch } from 'actions';
...
const DetailScreen = (props) => {
  ...
  const searchDelayed = _.debounce(execSearch, 300);
...
export default connect(mapStateToProps, { businessNameSearch })(DetailScreen);
